    ...
    w.prototype = [], w.prototype.constructor = w, T.extend = function () {
        ...
        if (y && h.removeChild(y), h.appendChild(d), "year" === e || "month" === e)T(n.elemMain[t]).addClass("laydate-ym-show"), T(d).find("li").on("click", function () {
            ...
            if (!T(this).hasClass(s)) {
                if (0 === t)i[e] = r, l && (n.startDate[e] = r), n.limit(T(n.footer).find(p), null, 0); else if (l)n.endDate[e] = r; else {
        ...
        var n = this, a = n.config, i = t || (e ? T.extend({}, n.endDate, n.endTime) : a.range ? T.extend({}, n.startDate, n.startTime) : a.dateTime), r = n.format.concat();
